...
# 打印一些提示信息，让你知道切换成功了
echo "🚀 正在启动 Claude Code - ModelScope MiniMax"
...
export ANTHROPIC_DEFAULT_SONNET_MODEL="MiniMax/MiniMax-M2"
export ANTHROPIC_DEFAULT_OPUS_MODEL="MiniMax/MiniMax-M2"
