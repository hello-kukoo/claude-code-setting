...
please write out this plan, in full detail, into `docs/plans/somefeature.plan.md`, as a series of prompts for an llm coding agent. DRY YAGNI simple clean clear good code
